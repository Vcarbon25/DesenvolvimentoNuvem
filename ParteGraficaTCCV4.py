...
LPonto1 = TK.Label(raiz, text='Coordenadas do 1 ponto: ')
LPonto1.grid(row=1,column=1)
LPonto2 = TK.Label(raiz,text='Coordenadas do ponto 2:  ')
LPonto2.grid(row=2,column=1)
LPonto3 = TK.Label(raiz,text='Coordenadas do ponto 3:  ')
LPonto3.grid(row=3,column=1)
LResultadoAnalise = TK.Label(raiz,text='Angulo entre segmentos R12 e R23:  numero  [°]')
LResultadoAnalise.grid(row=5,column=1)
Modelo_Corpo()
raiz.mainloop()